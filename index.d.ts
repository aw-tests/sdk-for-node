declare module "node-appwrite" {
  ...
  export class Database extends Service {
     ...
     * @returns {Promise}
     */
    getAttribute(collectionId: string, attributeId: string): Promise<Response>;
    /**
     * Delete Attribute
     *
     * @param {string} collectionId
     ...
     * @returns {Promise}
     */
    deleteAttribute(collectionId: string, attributeId: string): Promise<Response>;
    /**
     * List Documents
     *
     ...
     * @returns {Promise}
     */
    deleteIndex(collectionId: string, indexId: string): Promise<Response>;
  }
